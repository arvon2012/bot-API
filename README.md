...
接口：  
  1. [创建账号，存储apikey和私钥](#创建账号，存储apikey和私钥)  

  2. [修改账号，包括账号名，apikey和私钥](#修改账号，包括账号名，apikey和私钥)

  3. [机器人参数设置（创建/编辑/启动/停止）](#机器人参数设置（创建/编辑/启动/停止）)

  4. [机器人批量参数设置（创建/编辑/启动/停止）](#机器人批量参数设置（创建/编辑/启动/停止）)

  5. [清仓卖出](#清仓卖出)

  6. [获取机器人列表](#获取机器人列表)

  7. [单个机器人工作状态接口](#单个机器人工作状态接口)
